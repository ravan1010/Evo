...
const { home, getpost, search, searchResult, eventpostbyid, eventAvailabledates, booking, setting, address, success, booked, eventpostdataforbook, eventAvailabledatesandcategory, explore } = require('../controller/UI.controller.js')
