          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            <div className="bg-white p-6 rounded-lg shadow">
              <div className="flex items-center">
                ...
                <div className="ml-4">
              <Link to='/clientslandmark/productcreate' className=' border-2 mx-1 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-2xl'>Create Event</Link>
                </div>
              </div>
            </div>
            <div className="bg-white p-6 rounded-lg shadow">
...
export default Clientslandmarkdashboard
